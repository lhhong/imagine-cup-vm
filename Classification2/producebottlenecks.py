...
model_dir = 'inception'
original_image_dir = 'Clean clothes/Shoes/'
bottleneck_path = 'bottlenecks'



def create_bottleneck_file(sess, jpeg_data_tensor, bottleneck_tensor, image_dir):
...
def producebottlenecks(image_dir):
